...
\begin{frame}{Differentiability in higher dimensions}
    ...
    \end{itemize}
\end{frame}
\begin{frame}{Definition (optional)}
    \begin{definition}
    ...
    My lecture on this: \url{https://www.youtube.com/watch?v=e9X3zvyuvhk}. 
\end{frame}

\begin{frame}{Find the Derivative (optional)}
    \begin{example}
...
\end{frame}
\begin{frame}{Example}
Show that the function $f(z)=z^2$ is analytic.
\end{frame}
...
\begin{frame}{Example}
    \begin{example}
        Show that the function $f(z)=\sinh (2z)$ is analytic.
    \end{example}
\end{frame}
