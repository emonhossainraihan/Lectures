...
\begin{figure}[H]
\centering
\includegraphics[scale=0.2]{subbb.png}
\end{figure}
\end{frame}

\begin{frame}
    Determine whether the following sets are subspace of $\mathbb{R}^3$.
i. $W=\{(x, y, 0) \mid x, y \in \mathbb{R}\}$
ii. $W=\{(x, y, 1) \mid x, y \in \mathbb{R}\}$
iii. $W=\left\{(x, y, z) \in \mathbb{R}^3 \mid x \geq 0\right\}$
iv. $W=\left\{(x, y, z) \in \mathbb{R}^3 \mid x^2+y^2+z^2 \leq 1\right\}$
v. $W=\left\{(x, y, z) \in \mathbb{R}^3 \mid z=x+y+3\right\}$
\end{frame}

\begin{frame}
    $V=\left\{\left.\left(\begin{array}{ll}a & b \\ c & d\end{array}\right) \right\rvert\, a, b, c, d \in \mathbb{R}\right\}=M_{2 \times 2}(\mathbb{R})$. Determine whether the following sets are subspace of V .
i. $W=\left\{\left.\left(\begin{array}{ll}a & b \\ c & d\end{array}\right) \right\rvert\, a+b+c+d=0\right\}$
ii. $W=\left\{\left(\begin{array}{ll}a & b \\ c & d\end{array}\right) \left\lvert\, \operatorname{Det}\left(\begin{array}{ll}a & b \\ c & d\end{array}\right)=0\right.\right\}$
iii. $W=\left\{\left.\left(\begin{array}{ll}a & 0 \\ 0 & b\end{array}\right) \right\rvert\, a, b \in \mathbb{R}\right\}$
\end{frame}
